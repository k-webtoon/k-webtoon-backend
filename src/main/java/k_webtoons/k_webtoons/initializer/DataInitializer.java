...
public class DataInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (webtoonRepository.count() == 0) {
            String webtoonCsvFile = "C:\\Users\\haeunlove\\Desktop\\TP\\Data\\Dataset_add_cluster_character.csv";
        ...
        if (cosineTableRepository.count() == 0) {
            String similarityCsvFile = "C:\\Users\\haeunlove\\Desktop\\TP\\Data\\cosine_sim_top10_tabel.csv";
